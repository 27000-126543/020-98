import { Hand, CircleDot, Activity, ArrowLeftRight, Unlink } from 'lucide-react';
import { AnnotationType, ANNOTATION_COLOR, ANNOTATION_TYPE_LABEL } from '@/types';
import { cn } from '@/lib/utils';
import { ANNOTATION_TOOL_CONFIG } from './AnnotationPanel';

interface Props {
  activeTool: AnnotationType | 'pan' | null;
  onChange: (t: AnnotationType | 'pan' | null) => void;
}
...
export const AnnotationToolbar = ({ activeTool, onChange }: Props) => {
  return (
